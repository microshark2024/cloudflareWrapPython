...
# Import only pure-Python helpers – avoid importing the window directly
from cloudflare_warp.ui.main_window import _hex_to_rgb, _rgb_to_hex, _lerp_hex, _dim_hex
